  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <p className="text-xl md:text-2xl text-dark-600 max-w-3xl mx-auto text-balance leading-relaxed">
          {hero.subheadline}
        </p>
        ...
        <div className="bg-primary-50 border border-primary-200 rounded-lg p-6 max-w-2xl mx-auto">
          <p className="text-dark-700 text-lg">{hero.socialProof}</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            {isCopied ? (
              ...
              hero.cta.buttonText || "GET STARTED"
            )}
          </Button>
        </div>
